...
define('APIKEY', 'AIzaSyDxDv8-IyMSZ6cEfHT7evHVOpbQs4gXxio');
define('GJ_CODE', 'US');
define('SITE_NAME', 'y2bchina');
define('TITLENAME', 'y2bchina');
define('EN2DEKEY', '32123wwerwer323trbnkgfdgds');
define('EMAIL', 'liwen123@yandex.com');
define('NAME', 'admin');
define('PASSWORD', '8431756');
